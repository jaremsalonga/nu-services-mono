...
import ListShift from './components/GA/Pendings/Interviews/ListShift';
import ListAbsence from './components/GA/Pendings/Interviews/ListAbsense'
import ListTransfer from './components/GA/Pendings/Interviews/ListTransfer'
import ListGrad from './components/GA/Pendings/Interviews/ListGrad'
import ListSmartChat from './components/GA/Pendings/SmartChat/ListSmartChat'
  ...
  return (
    <Router>
      <UserProvider>
        ...
        <PrivateRoute exact path="/viewrequestdetails/shift/:shift_id" component={ListShift} role={['guidance associate']} />
        <PrivateRoute exact path="/viewrequestdetails/absence/:absencereq_id" component={ListAbsence} role={['guidance associate']} />
        <PrivateRoute exact path="/viewrequestdetails/transfer/:transferreq_id" component={ListTransfer} role={['guidance associate']} />
        <PrivateRoute exact path="/viewrequestdetails/grad/:gradreq_id" component={ListGrad} role={['guidance associate']} />
        <PrivateRoute exact path="/viewrequestdetails/smartchat/:smartchat_id" component={ListSmartChat} role={['guidance associate']} />
        <PrivateRoute exact path="/viewrequestdetails/goodmoral/:goodmoral_id" component={ListGoodMoral} role={['guidance associate']} />
        ...
        <PrivateRoute exact path="/announcement/edit" component={EditAnnouncement} role={['guidance associate']} />
